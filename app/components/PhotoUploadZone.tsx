    ...
    return (
      <div className="space-y-3">
        ...
        <button
          ...
          className="flex w-full min-h-[140px] flex-col items-center justify-center gap-3 rounded-[18px] border-2 border-dashed border-stone-300 bg-stone-50/80 py-12 px-8 transition-colors hover:border-stone-400 hover:bg-stone-100/80 focus:outline-none focus:ring-2 focus:ring-stone-500 focus:ring-offset-2"
        >
          {previews.length === 0 ? (
            <>
              <svg
