...
export default function QuestionAnswerForm({
  ...
  const handleSave = useCallback(() => {
    const answerType = question.answerType as "photo" | "text" | "either";
    if (answerType === "photo" && !answerPhoto) {
    ...
    if (answerType === "either" && !answerPhoto && !answerText.trim()) {
  ...
  }, [answerPhoto, answerText, question.answerType, onSave]);
  ...
  return (
    <div className="border-t border-stone-200 pt-4 mt-3" onClick={(e) => e.stopPropagation()}>
      {needsText && (
        <div className="mb-4">
          <textarea
        ...
        <div className="mb-4 space-y-2">
          {answerPhoto ? (
            ...
            <>
              ...
              >
                <svg viewBox="0 0 24 24" className="h-5 w-5 text-stone-600" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
